...
impl Type {
        ...
        /// INT2VECTORarray of int2, used in system tables
        ...
        /// INTERVALtime interval, format 'number units ...'
        ...
        /// TIMETZtime of day with time zone
        ...
        /// RECORDpseudo-type representing any composite type
        pub const RECORD: Type = Type(Inner::Record);
        /// CSTRINGC-style string
        pub const CSTRING: Type = Type(Inner::Cstring);
        /// ANYpseudo-type representing any type
        pub const ANY: Type = Type(Inner::Any);
        /// ANYARRAYpseudo-type representing a polymorphic array type
        pub const ANYARRAY: Type = Type(Inner::Anyarray);
        /// VOIDpseudo-type for the result of a function with no real result
        pub const VOID: Type = Type(Inner::Void);
        /// TRIGGERpseudo-type for the result of a trigger function
        pub const TRIGGER: Type = Type(Inner::Trigger);
        /// LANGUAGE_HANDLERpseudo-type for the result of a language handler function
        pub const LANGUAGE_HANDLER: Type = Type(Inner::LanguageHandler);
        /// INTERNALpseudo-type representing an internal data structure
        pub const INTERNAL: Type = Type(Inner::Internal);
        /// ANYELEMENTpseudo-type representing a polymorphic base type
        pub const ANYELEMENT: Type = Type(Inner::Anyelement);
        /// RECORD[]
        pub const RECORD_ARRAY: Type = Type(Inner::RecordArray);
        /// ANYNONARRAYpseudo-type representing a polymorphic base type that is not an array
        ...
        /// TXID_SNAPSHOTtransaction snapshot
        pub const TXID_SNAPSHOT: Type = Type(Inner::TxidSnapshot);
        /// FDW_HANDLERpseudo-type for the result of an FDW handler function
        pub const FDW_HANDLER: Type = Type(Inner::FdwHandler);
        /// PG_LSNPostgreSQL LSN
        pub const PG_LSN: Type = Type(Inner::PgLsn);
        /// PG_LSN&#91;&#93;
        pub const PG_LSN_ARRAY: Type = Type(Inner::PgLsnArray);
        /// TSM_HANDLERpseudo-type for the result of a tablesample method function
        pub const TSM_HANDLER: Type = Type(Inner::TsmHandler);
        /// PG_NDISTINCTmultivariate ndistinct coefficients
        pub const PG_NDISTINCT: Type = Type(Inner::PgNdistinct);
        /// PG_DEPENDENCIESmultivariate dependencies
        pub const PG_DEPENDENCIES: Type = Type(Inner::PgDependencies);
        /// ANYENUMpseudo-type representing a polymorphic base type that is an enum
        pub const ANYENUM: Type = Type(Inner::Anyenum);
        /// TSVECTORtext representation for text search
        pub const TS_VECTOR: Type = Type(Inner::TsVector);
        /// TSQUERYquery representation for text search
        pub const TSQUERY: Type = Type(Inner::Tsquery);
        /// GTSVECTORGiST index internal text representation for text search
