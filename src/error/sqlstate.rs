...
impl SqlState {
    ...
    /// 10608
    pub const INVALID_ARGUMENT_FOR_XQUERY: SqlState = SqlState(Inner::E10608);
    /// 20000
    ...
    /// 58P03
    pub const FILE_NAME_TOO_LONG: SqlState = SqlState(Inner::E58P03);
    /// F0000
...
static SQLSTATE_MAP: phf::Map<&'static str, SqlState> = ::phf::Map {
    ...
    entries: &[
        ...
        ("22008", SqlState::DATETIME_VALUE_OUT_OF_RANGE),
        ...
        ("26000", SqlState::UNDEFINED_PSTATEMENT),
        ...
        ("10608", SqlState::INVALID_ARGUMENT_FOR_XQUERY),
        ...
        ("34000", SqlState::UNDEFINED_CURSOR),
        ...
        ("3F000", SqlState::UNDEFINED_SCHEMA),
        ...
        ("2202E", SqlState::ARRAY_SUBSCRIPT_ERROR),
        ...
        ("58P03", SqlState::FILE_NAME_TOO_LONG),
        ...
        ("3D000", SqlState::UNDEFINED_DATABASE),
